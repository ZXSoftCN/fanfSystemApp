...
// 模块管理
export const menu = createApi(`${path}/menu/queryTopMenuAllTree`, option) // 获取菜单 // 获取模块列表
export const fetchModuleDelete = createApi(`${path}/menu/delete`, option) // 删除模块
export const fetchModuleDetail = createApi(`${path}/menu/getEntity`, option) // 获取模块详情
// export const fetchChangeModuleStatus = createApi(`${path}/menu/delete`, option) // 修改模块显隐状态
export const fetchModuleUpdateDetail = createApi(`${path}/menu/modifyEntity`, option) // 修改模块详情
export const fetchModuleAdd = createApi(`${path}/menu/addEntity`, option) // 新增模块
export const fetchButtonList = createApi(`${path}/menu/getDetailPermission`, option) // 按钮权限列表
